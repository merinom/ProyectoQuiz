...
var contadorController= require('../controllers/contador_controller');
/* GET home page. */
...
//BUSQUEDA PREGUNTA POR USUARIO
router.get('/owner', quizController.owner);
router.get('/ownerq',quizController.ownerq);
...
//Pagina información usuarios
router.get('/contador/contador',contadorController.cuenta);
